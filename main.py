""" Модуль 9. День 1. Object oriented programming"""

from typing import List
# Задача 1. Описать класс программист. Описать класс IT-компания.
class Programmer:
...
class ITCompany:
    ...
    def __init__(self, name: str, address: str, programmers: List[Programmer] = None):
        self.name = name
